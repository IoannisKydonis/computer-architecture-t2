...
Παρατηρούμε δηλαδή ότι δεν μπορεί να υπάρξει τέλειο scaling καθώς το CPI στην πράξη δεν εξαρτάται μόνο από τον επεξεργαστή αλλά και από την ανάγκη του πορογράμματος που εκτελείται για πρόσβαση στη μνήμη.
